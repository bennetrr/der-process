            ...
            <div className={styles.page_content}>
                <div className={styles.text_only_content}>
                    ...
                    <p>
                        ...
                        vor dem Gericht so gut wie möglich zu minimieren. Des Weiteren dürfen Advokaten nicht bei den
                        Verhören anwesend sein, sondern müssen die Angeklagten danach ausfragen oder ihrer Informationen
                        durch Bestechungen von niedrigeren Beamten oder Aktendiebstähle beschaffen. Wichtiger seien aber
                        persönliche Beziehungen mit höheren Beamten, die nur wenige Advokaten haben. Die Gerichtsbeamten
                        würden auch öfters die Advokaten um eine Meinung bitten, falls sie nicht weiterkommen. Dann
                        meint Huld, die Rede, die K. bei seiner ersten Untersuchung vor dem Kanzleidirektor gehalten
                        hat, habe den Direktor als wichtige Person, mit der man etwas gegen den Prozess bewirken könne,
                        gestrichen. Die einzige Ablenkung ist Leni, die während den Gesprächen Tee bringt und K. die
                        Hand hält.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        Gericht befand. Als Erstes wird er von mehreren aufdringlichen Mädchen zum Maler geführt, die
                    ...
                    <p>
                        ...
                        scheinbarer Freispruch, bestehe daraus, ein Bestätigungsschreiben für K.&apos;s Unschuld den
                        Richtern zu geben, sodass der Richter ihn freispreche. Die einzige Einschränkung sei, dass K.
                        ...
                        künstlich auf der unteren Gerichtsebene bleibe, in dem man den Richter ständig beeinflusst.
                    ...
                    <p>
                        ...
                        entgegnet, dass <i>&quot;Gerichtskanzleien [...] fast auf jedem Dachboden [sind]&quot;</i>.
                    </p>

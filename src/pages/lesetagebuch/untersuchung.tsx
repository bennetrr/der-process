            ...
            <div className={styles.page_content} style={{background: '#1a1a1a'}}>
                <div className={styles.text_only_content}>
                    ...
                    <p>
                        ...
                        Währenddessen sagt der Richter kein Wort. Als K. fertig war, wird das Verhör beendet.
                    </p>
                    ...
                    <ul className={styles.list}>
                        ...
                        <li>Wenn K., genauso wie der Autor, auch Jude ist, könnten die Aktionen vielleicht Kafkas
